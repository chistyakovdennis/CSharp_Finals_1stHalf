...
// Эта программа сначала позволяет пользователю ввести элементы массива с клавиатуры через запятую. 
// Затем она создает новый массив, содержащий только те строки, которые имеют длину, меньшую или равную 3 символам, 
